import React, { useState,
  ...
  import { requestToGroup, deleteToGroup, acceptToGroup } from "../../services/groupService";
    ...
    return (
      <>
        <div className={cx("group__info")}>
            ...
            {status === "INVITED" ? (
                <div className={cx("group__btn")} style={{display: "flex", justifyContent:"space-between" }}> 
                    <button
